...
const MakeAppoinment = () => {
    return (
        <section className='mt-16 rounded'
            style={{
            ...
            <div className="hero">
                <div className="hero-content flex-col lg:flex-row">
                    <img src={doctor} alt='' className="-mt-32 h-96 hidden md:block lg:w-1/2" />
                    <div>
                        <h4 className='text-md text-primary font-bold'>Appointment</h4>
